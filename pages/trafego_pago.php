        ...
        <main>
            <header class="background-preto">
                <nav id="lista__links_principais">
                    <div>
                        <a href="../index.html" style="display: flex;"><img id="imagem__logo_subindo" src="../assets/images/logos/logo-subindo900x248.png" alt="Logo Subindo Agência"></a>
                    </div>
                    <ul>
                        ...
                        <li id="click__links_secundarios">
                            ...
                            <nav id="lista__links_secundarios">
                                <ul>
                                    ...
                                    <li><a href=""><p class="color-vermelho">Tráfego Pago</p></a></li>
                                </ul>
                            </nav>
                        </li>
            ...
            <section>
                ...
                <div id="container__above_the_fold_trafego" class="background-preto centralizar padding-sessoes">
